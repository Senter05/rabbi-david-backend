...
def generate_narration_script(config, answers, reading=None, plan=None):
    ...
    Target: 800-1000 spoken words (4-5 minutes of audio at standard 150-170 WPM).
    ...
    if key:
        prompt = (
            ...
            "Your speech MUST be between 800 and 1000 words in length (strictly 4 to 5 minutes of spoken audio). "
            ...
            f"MANDATORY REQUIREMENT - ROOT FINANCIAL LEAK & COMPANION BOOK: "
            f"Address their root financial leak directly with deep pastoral insight: '{rec['leak_diagnosis']}' "
            f"Rabbi David MUST explicitly speak aloud the exact title of his companion book: '{rec['title']}'. "
            f"He must explain directly: 'In your fourteen-day companion, on Day 3, Day 7, and Day 14, you reach three Sacred Milestones where the vessel must be sealed. "
            f"In this brief spoken blessing, I cannot give you the full liturgical procedures, the physical preparations, or the sacred prayers. "
            f"That is why you must open {rec['title']} on our website, rabbidavid.org, where the complete step-by-step rituals are written down. "
            f"You cannot complete the milestone vessel activations with general intentions alone; you need the exact ancient formulas I have preserved in that book.' "
            "Deliver this guidance not as an advertisement, but as a wise elder giving the indispensable, life-altering instruction they must follow. "
            ...
            "Ensure the total word count is strictly between 800 and 1000 words."
        )
        user_data = dict(
            name=name,
            goal=goal_label,
        ...
        try:
            ...
            clean = re.sub(r'\n{3,}', '\n\n', clean)
            words = clean.split()
            if 750 <= len(words) <= 1100:
                if len(words) > 1000:
                    clean = fit_words(clean, 800, 1000)
                return clean
        except Exception:
            pass
    ...
    paragraphs = [
        f"Shalom, {name}. Welcome into my study here in Jerusalem. Pull up a chair, sit comfortably, and let us take a quiet breath together. For many decades, men and women from every corner of the world have walked through my door carrying the very questions resting upon your heart today. When I read your responses, I felt a deep kinship with where you stand right now. You have chosen to focus your heart upon {goal_label}. That is not an accident, {name}. In our tradition, the desire to bring order, dignity, and peace to your life is recognized as a sacred awakening of the soul that asks for more than mere survival; it asks for enduring blessing.",
        "Let me share something fundamental that the ancient sages taught about prosperity and peace. In modern life, we are conditioned to believe that wealth is purely a numbers game—a race against time, a relentless accumulation driven by panic. We are told that if we only push harder, fear will disappear. But in the ancient wisdom of the Torah, money and abundance are forms of spiritual energy. The Hebrew word for wealth is linked to deep inner satisfaction. A person consumed by fear can possess millions in the bank and live as a pauper in their soul. Conversely, one who understands how to build a proper vessel—a kli—can receive blessings so that they endure, bringing peace to their family and clarity to their days.",
        f"Over thirty years ago, an experienced merchant sat across from me in this very room, {name}. Outwardly successful, his hands trembled as he poured tea because every morning began with a knot of dread. I shared with him the ancient teaching from the Ethics of the Fathers: Who is truly wealthy? The one who rejoices in their portion and governs their own spirit with deliberate patience. When you try to carry water in a fractured jar, it leaks out no matter how much you pour into it.{evidence_str} Our work together over the next two weeks is to repair that vessel so that the blessings you cultivate can settle and remain in your life.{step_str}",
        f"Consider your daily life right now. You indicated that you have about {time_mins} minutes each day for personal reflection. Do not make the mistake of thinking that {time_mins} minutes is too modest to make a difference. The great master Rabbi Israel Salanter taught that a drop of water falling consistently upon a stone will carve a path through solid granite, whereas a violent torrent merely washes over the surface. King Solomon wrote in Proverbs that the plans of the diligent lead surely to abundance, but everyone who is hasty comes only to poverty. That word hasty means acting from panic. Before you take any rushed financial step, pause at the threshold and ask: Am I choosing this out of fear, or out of quiet clarity?",
        f"Now, looking ahead to the fourteen-day plan placed into your hands, approach it not as an examination, but as a daily appointment with your own soul. Each morning, open the day's guidance, read the teaching, and engage with the practical action with an open heart. Follow the steps faithfully, one day at a time, and allow this timeless wisdom to quietly reorder your inner life.",
        f"Yet, {name}, as your elder, I must share one further pastoral truth with you. Look closely at the fourteen-day companion placed into your hands. On Day 3, Day 7, and Day 14, you will arrive at three Sacred Milestones. These are not mere reflections; they are the moments where you must physically seal the leaks in your vessel. In this brief audio blessing, I cannot hand you the full liturgical formulas, the exact Hebrew words of protection, or the step-by-step physical procedures. That is why I wrote '{rec['title']}'. In its pages, I reveal the exact rituals—such as {rec['key_ritual']}—that seal the vessel against dissipation. When you reach Day 3, Day 7, and Day 14, you must open '{rec['title']}' on our website, rabbidavid.org, where the complete instructions are preserved for you. You cannot seal a leaking vessel with good intentions alone; you must implement the exact discipline. Keep this wisdom before your eyes as you begin Day 1 tomorrow morning.",
        f"As we conclude this time together, {name}, I offer you an ancient blessing from the depths of my heart. May the Almighty bless you and protect you. May the light of divine wisdom illuminate your eyes and grant you discernment in all your dealings. May peace rest upon your household, health reside in your body, and fruitful abundance reward the honest labor of your hands. May you walk with dignity, speak with kindness, and live with the profound knowledge that your life is guided, cherished, and rich with promise. Amen, and may your journey forward be blessed with light and peace."
    ]
    return "\n\n".join(paragraphs)
